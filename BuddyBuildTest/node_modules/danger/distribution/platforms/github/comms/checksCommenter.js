...
exports.GitHubChecksCommenter = function (api) {
    ...
    return {
        ...
        handlePostingResults: function (results, options) { return __awaiter(_this, void 0, void 0, function () {
            var pr, octokit, custom, generatedJWT, checkData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, resultsToCheck_1.resultsToCheck(results, options, pr, octokit)];
                    case 5:
                        checkData = _a.sent();
                        return [4 /*yield*/, octokit.checks.create(checkData)
