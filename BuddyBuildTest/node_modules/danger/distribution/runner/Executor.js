            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(failureCount + messageCount === 0)) return [3 /*break*/, 7];
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(_i < previousComments_1.length)) return [3 /*break*/, 6];
                    ...
                    case 9:
                        ...
                        issueURL = undefined;
                        if (!DangerResults_1.isEmptyResults(mergedResults)) return [3 /*break*/, 10];
                    ...
                    case 13:
                        ...
                        _a.label = 14;
                    case 14:
                        if (!this.options.verbose) return [3 /*break*/, 16];
                        return [4 /*yield*/, this.handleResultsPostingToSTDOUT(results)];
                    case 15:
                        _a.sent();
                        _a.label = 16;
